...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--update_date", type=str, default="1999-01-01", help="업데이트할 최신데이터 날짜")
...
def main(args: argparse.Namespace) -> None:
    ...
    pozalabs_samples = utils.load_poza_meta(args.backoffice_api_url + "/api/samples", args.update_date, per_page=2000)
